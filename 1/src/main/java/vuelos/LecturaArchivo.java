...
public class LecturaArchivo {
     ...
     */
    static String ArchivoDeAeropuertos_TXT = "1/src/main/java/vuelos/aeropuertos.txt";
    static String ArchivoDeVuelos_TXT = "1/src/main/java/vuelos/vuelos.txt";
...
*/
      ...
      public void lecturaOrdenada(PriorityQueue<String> pq) throws IOException {
        BufferedReader in = new BufferedReader(new FileReader(ArchivoDeAeropuertos_TXT));
        String line;
        while ((line = in.readLine()) != null) {
          pq.add(line);
      ...
      public void borrarAeropuertoDeArchivo(String ArchivoDeAeropuertos_TXT, String lineToRemove) {
        ...
        try {
          ...
          // Se construye el nuevo archivo que despues va a ser el renombrado al nombre
          // original
      ...
      public static void darDeAltaAeropuerto() {
        ...
        String lineaNueva = (codigoIATANuevo + " " + nombreAeropuertoNuevo + " " + ciudadNueva + " " + paisNuevo + " "
